...
import { Building2, Home, Mail, Settings } from "lucide-react";
...
export function UserSidebar({ isCollapsed = false }: UserSidebarProps) {
  const location = useLocation();

  return (
    <aside
      className={`hidden shrink-0 flex-col justify-between border-r border-white/10 bg-secondary p-4 transition-all duration-300 ease-in-out sm:flex ${
