...
import { useCreateOrganizationRole } from "../../api/organizationMutations";
import {
  createRoleSchema,
...
export function CreateRoleSheet({
  ...
  const { mutate: createRole, isPending } = useCreateOrganizationRole();
        ...
        onError: (err: any) => {
          ...
          if (!backendErrors || typeof backendErrors !== "object") {
            ...
            Object.keys(backendErrors).forEach((key) => {
              const fieldKey = key as keyof CreateRoleFormValues;
        ...
        >
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            <div className="flex items-start justify-between border-b border-white/10 pb-4">
              <div>
                <h2 className="text-lg font-bold text-white">Create Role</h2>
                <p className="mt-1 text-xs text-gray-400">
                  Create a reusable organization role.
                </p>
              </div>
              <button
                type="button"
